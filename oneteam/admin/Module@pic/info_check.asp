...
KeyWord      = Gi_fChgSQLStr(Trim(Request.Form("KeyWord")))
UpLoad_Image = Gi_fChgSQLStr(Trim(Request.Form("UpLoad_Image")))
UpLoad_File  = Gi_fChgSQLStr(Trim(Request.Form("UpLoad_File")))
State_OnOff  = Gi_fChgSQLStr(Trim(Request.Form("OnOff")))
ReleaseDate  = Gi_fChgSQLStr(Trim(Request.Form("ReleaseDate")))
iLanguage    = Gi_fChgSQLStr(Trim(Request.Form("iLanguage")))
UpLoad_Image1 = Gi_fChgSQLStr(Trim(Request.Form("UpLoad_Image1")))
...
'	If Content) = "" Then Call Gi_sOnErrGoBack("正文内容！")
		StrSQL = "insert into "& StrDBPrefix &"Info(IDTree,Title,Intro,Content,KeyWord,UpLoad_File,UpLoad_Image,UpLoad_Image1,State_OnOff,ReleaseDate,iLanguage,pxid) values('"& IDTree &"'"
		StrSQL = StrSQL & ",'"& Title &"'"
		StrSQL = StrSQL & ",'"& Intro &"'"
