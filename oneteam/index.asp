...
<title>PRODUCTS LIST</title></HEAD>
<BODY>
<!--#include file="top.asp"-->
<%
idtree=request("idtree")
if idtree="" then
	set rs=fGetRsList("select top 1 * from hs_infotype where tptree like '.0.2.%' and tplevel=2 order by pxid desc,releasedate desc ,tpid asc")
...
<!--#include file="left.asp"-->
 ...
 <div id="right">
  ...
  <div id="topright">
	 ...
	 <div id="topright2">PRODUCTS LIST  </div>
	 <div id="topright3"><a href="#"><img src="img/msn.jpg" /></a><a href="#"><img src="img/skype.jpg" /></a><a href="#"></a></div>
		 ...
		 <%
			...
			if not(rs.bof and rs.eof) then
				...
				do while jj<MaxPerPage and not rs.eof
					jj=jj+1
			%>
	      <li><a href="detail.asp?id=<%=rs("id")%>"><img src="<%=imgurl(rs("upload_image"))%>" class="listimg" alt="<%=rs("title")%>"/><b><%=rs("title")%></b></a></li>
	      <%
						rs.movenext
					loop
