...
document.write( " <iframe   name=meizzCalendarIframe   scrolling=no   frameborder=0   width=146   height=193> </iframe> </div> ");
...
function   WebCalendar()   //初始化日历的设置
{
        ...
        this.darkColor     =   "#9999FF ";         //控件的暗色
        this.lightColor   =   "#FFFFFF ";         //控件的亮色
        this.btnBgColor   =   "#D6DFF5 ";         //控件的按钮背景色
        this.wordColor     =   "#333366 ";         //控件的文字颜色
        this.wordDark       =   "#DCDCDC ";         //控件的暗文字颜色
        this.dayBgColor   =   "#F1F4FC ";         //日期数字背景色
        this.todayColor   =   "#9999FF ";         //今天在日历上的标示背景色
